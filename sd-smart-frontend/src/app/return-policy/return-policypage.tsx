  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950 font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-left w-full">
        <p className="text-xs font-bold text-[#D71920] uppercase tracking-widest mb-2">Legal</p>
        <h1 className="text-4xl font-black text-[#1C1C1C] leading-tight mb-6">
          Return Policy
        </h1>
        <p className="text-neutral-500 max-w-xl leading-relaxed">
          We want you to love your SD SMART kitchen experience. If you are not completely satisfied, review our return and exchange guidelines within 10 days of delivery.
        </p>
      </main>
