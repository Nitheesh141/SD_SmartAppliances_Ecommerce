...
const getProducts = async (req, res) => {
    try {
        ...
        if (search) {
            ...
            formattedProducts = formattedProducts.filter((p) => (0, search_1.matchProduct)(p, queryStr));
        }
