...
exports.deleteDistributor = exports.updateDistributorStatus = exports.getDistributors = exports.distributorSignup = exports.convertToDistributor = exports.updateProfile = exports.loginWithOtp = exports.sendOtp = exports.changePassword = exports.resetPassword = exports.forgotPassword = exports.getMe = exports.login = exports.adminSignup = exports.signup = void 0;
...
const convertToDistributor = async (req, res) => {
    try {
        const userId = req.user?.id;
        if (!userId) {
            res.status(401).json({ success: false, message: "Not authenticated" });
        ...
        const { companyName, addressLine1, addressLine2, city, state, pincode, gstin, mobileNumber } = req.body;
...
exports.convertToDistributor = convertToDistributor;
// Distributor Signup
const distributorSignup = async (req, res) => {
    try {
        const { distributorName, contactPersonName, email, mobileNumber, gstNumber, businessName, businessAddress, password, } = req.body;
        ...
        const token = jsonwebtoken_1.default.sign({ id: result.user.id, email: result.user.email, role: result.user.role }, JWT_SECRET, { expiresIn: JWT_EXPIRES_IN });
        res.status(201).json({
            success: true,
...
exports.distributorSignup = distributorSignup;
...
const getDistributors = async (req, res) => {
    try {
        ...
        const distributors = await db_1.prisma.user.findMany({
            where: {
                role: "DISTRIBUTOR"
            },
            orderBy: {
...
const updateDistributorStatus = async (req, res) => {
    try {
        ...
        const distributor = await db_1.prisma.user.findUnique({
            where: { id: targetId }
        });
...
exports.updateDistributorStatus = updateDistributorStatus;
