...
const runPricingEngine = async (user, items, couponCode) => {
    ...
    // 1. PRODUCT_DISCOUNT
    const productOffers = activeOffers.filter((o) => o.offerType === "PRODUCT_DISCOUNT");
    ...
    // 2. CATEGORY_DISCOUNT
    const categoryOffers = activeOffers.filter((o) => o.offerType === "CATEGORY_DISCOUNT");
    ...
    // 3. BRAND_DISCOUNT
    const brandOffers = activeOffers.filter((o) => o.offerType === "BRAND_DISCOUNT");
    ...
    // 4. QUANTITY_DISCOUNT
    const qtyOffers = activeOffers.filter((o) => o.offerType === "QUANTITY_DISCOUNT");
    ...
    const genericDiscounts = activeOffers.filter((o) => o.offerType === "FLAT_DISCOUNT" || o.offerType === "PERCENTAGE_DISCOUNT");
    ...
    const cartValueOffers = activeOffers.filter((o) => o.offerType === "CART_VALUE_DISCOUNT");
    ...
    // 11. COUPON_DISCOUNT
    if (couponCode) {
        const matchingCoupon = activeOffers.find((o) => o.offerType === "COUPON" &&
            String(o.configuration.couponCode || o.code).trim().toLowerCase() === couponCode.trim().toLowerCase());
        if (matchingCoupon) {
            const config = matchingCoupon.configuration;
